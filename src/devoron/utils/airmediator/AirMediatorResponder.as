package devoron.utils.airmediator
{
	...
	/**
	 * AirMediatorResponder
	 * @author Devoron
	 */
	public class AirMediatorResponder extends Object
	{
		...
		public function AirMediatorResponder(path:String, resultHandler:Function, errorHandler:Function, needDownload:Boolean = false)
		{
		...
		public function responderResultFunction(e:*):void
		{
			...
			if (e.result is FileInfo)
			{
				...
				if (needDownload && !fileInfo.isDirectory && fileInfo.data==null)
				{
		...
		public function responderErrorFunction(e:*):void
		{
			if (errorHandler != null)
