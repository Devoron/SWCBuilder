package devoron.sdk.sdkmediator.ascsh.commands
{
	...
	public class CommandCell extends AbstractListCell
	{
		...
		{
			//nameLB.setForeground(new ASColor(0xC93C18, 0.4));
		 ...
		 */
			...
			command = value as CMD;
			nameLB.setText(command.getDesctiption());
