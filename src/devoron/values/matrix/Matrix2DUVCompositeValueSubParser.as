package devoron.values.matrix
{
	...
	import devoron.particles.parsers.particleSubParsers.values.ValueSubParserBase;
	import devoron.particles.parsers.particleSubParsers.AllIdentifiers;
	import devoron.particles.parsers.particleSubParsers.values.setters.matrix.Matrix2DUVCompositeSetter;
	...
	public class Matrix2DUVCompositeValueSubParser extends ValueSubParserBase
	{
		...
		override protected function proceedParsing():Boolean
		{
			if (_isFirstParsing)
			{
				...
				var valueCls:Class =AllSubParsers.getRelatedParser(Id, AllSubParsers.ALL_ONED_VALUES);
				if (!valueCls)
				{
